  ...
  return (
    <main className="relative min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#07D348]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#24fe41]/3 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 px-6 pt-32">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex flex-col items-center text-center mb-32">
            <div className="inline-flex h-10 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 text-sm text-white/70 backdrop-blur-sm transition-all hover:border-[#07D348]/30 hover:bg-[#07D348]/10 hover:text-[#07D348] animate-fade-in">
            ...
            <h1 className="mt-8 text-5xl font-bold tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl animate-slide-up">
              Report Incident
              <span className="block mt-4 bg-gradient-to-r from-[#07D348] to-[#24fe41] bg-clip-text text-transparent text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                Protect Public Safety
              </span>
            </h1>

            <p className="mt-8 max-w-2xl text-lg md:text-xl leading-relaxed text-white/60 animate-fade-in-delayed">
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4 animate-fade-in-up">
              ...
              <Link href="/auth/signin">
                <button className="flex h-12 items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-8 text-sm font-medium text-white backdrop-blur-sm transition-all hover:border-[#07D348]/30 hover:bg-[#07D348]/10 hover:text-[#07D348] group">
            ...
            {[
              {
                ...
                icon: (
                  <svg className="h-6 w-6 text-[#07D348]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <div
                key={i}
                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:border-[#07D348]/30 hover:bg-[#07D348]/10 hover:shadow-[0_0_30px_-10px_#07D348]"
              >
                <div className="relative">
                  ...
                  <p className="text-md leading-relaxed text-white/60">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Stats Section */}
          <div className="mb-32 rounded-3xl border border-white/10 bg-white/5 p-12 backdrop-blur-xl">
          ...
          <div className="mb-32 flex flex-col items-center gap-8 animate-fade-in">
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm text-white/70 backdrop-blur-xl transition-all hover:border-[#07D348]/30 hover:bg-[#07D348]/10 hover:text-[#07D348] group">
